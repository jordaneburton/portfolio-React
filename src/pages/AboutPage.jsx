...
function AboutPage () {
  ...
  return (
    <>
      ...
      <Row className='position-relative justify-content-center align-self-start page-margin'>
        <Col xs={9} md={3} className=''>
          <Image xs={9} md={3} src="/assets/profile_picture.jpg" 
            className='d-md-none border border-4 border-light rounded-pill mb-3 z-2' fluid 
            role="img" aria-label='Profile of Jordan Burton'/>
        </Col>
        <Col xs={12} md={6} className=''>
          ...
          <p className='fs-4 d-none d-md-block mt-5 align-bottom'>
